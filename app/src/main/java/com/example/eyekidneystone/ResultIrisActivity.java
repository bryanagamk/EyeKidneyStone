...
public class ResultIrisActivity extends AppCompatActivity {

    private ImageView ivFoto, ivFotoIris, ivROIGinjal, ivResultSegmentasi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_result_iris);

        ivFoto = findViewById(R.id.ivFoto);
        ivFotoIris = findViewById(R.id.ivFotoIris);
    ...
    private class PreprocessingTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... strings) {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    ivFotoIris.setImageBitmap(finalCropBmp);
                }
            });
